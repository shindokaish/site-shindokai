...
function renderWhatsApp() {
  ...
  Object.assign(btn.style, {
    position: 'fixed', bottom: '1.4rem', right: '1.4rem', zIndex: '900',
  ...
  btn.addEventListener('mouseenter', () => { btn.style.transform = 'scale(1.1)'; btn.style.boxShadow = '0 6px 22px rgba(0,0,0,.4)'; });
  btn.addEventListener('mouseleave', () => { btn.style.transform = ''; btn.style.boxShadow = '0 4px 16px rgba(0,0,0,.35)'; });
  document.body.appendChild(btn);
}
